...
[
        {
            ...
            url_imagen: "https://mighty.tools/mockmind-api/content/human/1.jpg"
        },
        {
            ...
            url_imagen: "https://mighty.tools/mockmind-api/content/human/4.jpg"
        ...
        },
        {
            ...
            url_imagen: "https://mighty.tools/mockmind-api/content/human/2.jpg"
        ...
        },
        {
            ...
            url_imagen: "https://mighty.tools/mockmind-api/content/human/18.jpg"
        ...
        },
        {
            ...
            url_imagen: "https://mighty.tools/mockmind-api/content/human/21.jpg"
        ...
        <div className="grid grid-cols-1 gap-6 p-6 mx-auto max-w-6xl md:grid-cols-2">
            {testimonials.map((testimonial, index) => (
                <div key={index} className="flex">
                    <img src={testimonial.url_imagen} alt={testimonial.nombre} className="object-cover relative z-10 mb-4 w-32 h-32 rounded-full border-4 shadow-lg border-terciary" />
                    <div className="p-4 -ml-3 bg-white rounded-lg border-4 shadow-lg border-terciary">
