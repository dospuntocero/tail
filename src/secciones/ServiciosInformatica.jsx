// pages/ServiciosInformatica.js

import React from 'react';
import Servicios from '../componentes/Servicios';

const serviciosInformatica = [
  {
    name: 'Diseño Gráfico',
    description: 'Nos enfocamos en mejorar la presencia visual de tu marca. Ofrecemos un servicio integral que incluye:',
    incluye: ['Asesoramiento', 'Branding institucional', 'Packaging', 'Diseño ecológico'],
  ...
  },
  {
    ...
    incluye: ['Diseño Web estático o dinámico', 'E-commerce (Tiendas online)', 'Landing page (Página de inicio)', 'Web corporativas e informativas'],
  ...
  },
  {
    ...
    incluye: ['Asesoramiento personalizado', 'Alcance de público objetivo', 'Comunicación asertiva', 'Análisis de rendimiento', 'Actualizaciones constantes'],
  ...
  },
  {
    ...
    incluye: ['Fotografía Corporativa', 'Fotografía Publicitaria', 'Fotografía de Moda', 'Fotografía de Gastronomía', 'Fotografía de Productos', 'Fotografía e-Commerce'],
...
export default ServiciosInformatica;
